...
| 5 قوالب أهداف جاهزة | ✅ |
| حفظ البيانات محليًا (لا تُفقد عند إعادة التشغيل) | ✅ |
| إنشاء وحذف أهداف مخصصة | ✅ |
| إشعارات تذكير يومية | ✅ |
| مشاركة التقدم | ✅ |
| دعم الصوت والنطق (TTS) | ✅ |
| المزامنة السحابية (Firebase + Google) | ✅ * |
| الفريق: إنشاء/انضمام برمز دعوة + لوحة تقدّم | ✅ * |

\* المزامنة والفرق جاهزة برمجيًا لكنها تتطلب إعداد Firebase — انظر [FIREBASE_SETUP.md](FIREBASE_SETUP.md).

## الميزات القادمة (v2)

- [ ] فوترة اشتراك الفريق (تحتاج مزوّد دفع)
