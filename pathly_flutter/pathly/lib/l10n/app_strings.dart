...
class AppStrings {
  ...
  // Cloud sync
  String get cloudSync          => _t(ar: 'المزامنة السحابية', en: 'Cloud sync', fr: 'Synchronisation cloud', es: 'Sincronización en la nube', tr: 'Bulut senkronizasyonu', ur: 'کلاؤڈ سنک', hi: 'क्लाउड सिंक', id: 'Sinkronisasi cloud', ms: 'Penyegerakan awan', sw: 'Usawazishaji wa wingu');
  String get cloudSyncDesc      => _t(ar: 'زامن أهدافك عبر أجهزتك', en: 'Sync your goals across devices', fr: 'Synchronisez vos objectifs sur vos appareils', es: 'Sincroniza tus metas entre dispositivos', tr: 'Hedeflerini cihazlar arasında senkronize et', ur: 'اپنے اہداف کو آلات کے درمیان سنک کریں', hi: 'अपने लक्ष्यों को उपकरणों में सिंक करें', id: 'Sinkronkan tujuan di semua perangkat', ms: 'Segerakkan matlamat merentas peranti', sw: 'Sawazisha malengo yako kwenye vifaa');
  String get signInGoogle       => _t(ar: 'تسجيل الدخول عبر Google', en: 'Sign in with Google', fr: 'Se connecter avec Google', es: 'Iniciar sesión con Google', tr: 'Google ile giriş yap', ur: 'Google سے سائن ان کریں', hi: 'Google से साइन इन करें', id: 'Masuk dengan Google', ms: 'Log masuk dengan Google', sw: 'Ingia na Google');
  String get signOut            => _t(ar: 'تسجيل الخروج', en: 'Sign out', fr: 'Se déconnecter', es: 'Cerrar sesión', tr: 'Çıkış yap', ur: 'سائن آؤٹ', hi: 'साइन आउट', id: 'Keluar', ms: 'Log keluar', sw: 'Toka');
  String get uploadToCloud      => _t(ar: 'رفع إلى السحابة', en: 'Upload to cloud', fr: 'Envoyer vers le cloud', es: 'Subir a la nube', tr: 'Buluta yükle', ur: 'کلاؤڈ پر اپلوڈ', hi: 'क्लाउड पर अपलोड', id: 'Unggah ke cloud', ms: 'Muat naik ke awan', sw: 'Pakia kwenye wingu');
  String get downloadFromCloud  => _t(ar: 'استرجاع من السحابة', en: 'Restore from cloud', fr: 'Restaurer depuis le cloud', es: 'Restaurar desde la nube', tr: 'Buluttan geri yükle', ur: 'کلاؤڈ سے بحال کریں', hi: 'क्लाउड से पुनर्स्थापित करें', id: 'Pulihkan dari cloud', ms: 'Pulihkan dari awan', sw: 'Rejesha kutoka wingu');
  String get signedInAs         => _t(ar: 'مسجّل باسم', en: 'Signed in as', fr: 'Connecté en tant que', es: 'Sesión iniciada como', tr: 'Giriş yapıldı:', ur: 'بطور سائن ان', hi: 'के रूप में साइन इन', id: 'Masuk sebagai', ms: 'Log masuk sebagai', sw: 'Umeingia kama');
  String get syncNotConfigured  => _t(ar: 'المزامنة غير مهيّأة (أكمل إعداد Firebase)', en: 'Sync not configured (complete Firebase setup)', fr: 'Sync non configurée (terminez la configuration Firebase)', es: 'Sincronización no configurada (completa Firebase)', tr: 'Senkronizasyon yapılandırılmadı (Firebase kurulumunu tamamla)', ur: 'سنک ترتیب نہیں (Firebase سیٹ اپ مکمل کریں)', hi: 'सिंक कॉन्फ़िगर नहीं (Firebase सेटअप पूरा करें)', id: 'Sync belum dikonfigurasi (selesaikan Firebase)', ms: 'Sync belum disediakan (lengkapkan Firebase)', sw: 'Usawazishaji haujawekwa (kamilisha Firebase)');
  String get uploaded           => _t(ar: 'تم الرفع إلى السحابة', en: 'Uploaded to cloud', fr: 'Envoyé vers le cloud', es: 'Subido a la nube', tr: 'Buluta yüklendi', ur: 'کلاؤڈ پر اپلوڈ ہو گیا', hi: 'क्लाउड पर अपलोड हुआ', id: 'Terunggah ke cloud', ms: 'Dimuat naik ke awan', sw: 'Imepakiwa kwenye wingu');
  String get downloaded         => _t(ar: 'تم الاسترجاع من السحابة', en: 'Restored from cloud', fr: 'Restauré depuis le cloud', es: 'Restaurado desde la nube', tr: 'Buluttan geri yüklendi', ur: 'کلاؤڈ سے بحال ہو گیا', hi: 'क्लाउड से पुनर्स्थापित', id: 'Dipulihkan dari cloud', ms: 'Dipulihkan dari awan', sw: 'Imerejeshwa kutoka wingu');
  String get downloadEmpty      => _t(ar: 'لا توجد نسخة سحابية', en: 'No cloud backup found', fr: 'Aucune sauvegarde cloud', es: 'No hay copia en la nube', tr: 'Bulut yedeği yok', ur: 'کوئی کلاؤڈ بیک اپ نہیں', hi: 'कोई क्लाउड बैकअप नहीं', id: 'Tidak ada cadangan cloud', ms: 'Tiada sandaran awan', sw: 'Hakuna nakala ya wingu');
  String get syncError          => _t(ar: 'تعذّرت المزامنة', en: 'Sync failed', fr: 'Échec de la synchronisation', es: 'Error de sincronización', tr: 'Senkronizasyon başarısız', ur: 'سنک ناکام', hi: 'सिंक विफल', id: 'Sinkronisasi gagal', ms: 'Penyegerakan gagal', sw: 'Usawazishaji umeshindwa');

  // Team
  String get team               => _t(ar: 'الفريق', en: 'Team', fr: 'Équipe', es: 'Equipo', tr: 'Takım', ur: 'ٹیم', hi: 'टीम', id: 'Tim', ms: 'Pasukan', sw: 'Timu');
  String get teamDesc           => _t(ar: 'تعاون وتابع تقدّم فريقك', en: 'Collaborate and track your team\'s progress', fr: 'Collaborez et suivez la progression de votre équipe', es: 'Colabora y sigue el progreso de tu equipo', tr: 'İş birliği yap ve takımının ilerlemesini izle', ur: 'تعاون کریں اور اپنی ٹیم کی پیشرفت دیکھیں', hi: 'सहयोग करें और अपनी टीम की प्रगति देखें', id: 'Berkolaborasi dan pantau kemajuan tim', ms: 'Bekerjasama dan jejaki kemajuan pasukan', sw: 'Shirikiana na fuatilia maendeleo ya timu yako');
  String get createTeam         => _t(ar: 'إنشاء فريق', en: 'Create team', fr: 'Créer une équipe', es: 'Crear equipo', tr: 'Takım oluştur', ur: 'ٹیم بنائیں', hi: 'टीम बनाएं', id: 'Buat tim', ms: 'Cipta pasukan', sw: 'Unda timu');
  String get joinTeam           => _t(ar: 'الانضمام لفريق', en: 'Join team', fr: 'Rejoindre une équipe', es: 'Unirse a un equipo', tr: 'Takıma katıl', ur: 'ٹیم میں شامل ہوں', hi: 'टीम में शामिल हों', id: 'Gabung tim', ms: 'Sertai pasukan', sw: 'Jiunge na timu');
  String get teamName           => _t(ar: 'اسم الفريق', en: 'Team name', fr: 'Nom de l\'équipe', es: 'Nombre del equipo', tr: 'Takım adı', ur: 'ٹیم کا نام', hi: 'टीम का नाम', id: 'Nama tim', ms: 'Nama pasukan', sw: 'Jina la timu');
  String get inviteCode         => _t(ar: 'رمز الدعوة', en: 'Invite code', fr: 'Code d\'invitation', es: 'Código de invitación', tr: 'Davet kodu', ur: 'دعوتی کوڈ', hi: 'आमंत्रण कोड', id: 'Kode undangan', ms: 'Kod jemputan', sw: 'Msimbo wa mwaliko');
  String get enterInviteCode    => _t(ar: 'أدخل رمز الدعوة', en: 'Enter invite code', fr: 'Saisir le code', es: 'Ingresa el código', tr: 'Davet kodunu gir', ur: 'دعوتی کوڈ درج کریں', hi: 'आमंत्रण कोड दर्ज करें', id: 'Masukkan kode undangan', ms: 'Masukkan kod jemputan', sw: 'Weka msimbo wa mwaliko');
  String get leaveTeam          => _t(ar: 'مغادرة الفريق', en: 'Leave team', fr: 'Quitter l\'équipe', es: 'Salir del equipo', tr: 'Takımdan ayrıl', ur: 'ٹیم چھوڑیں', hi: 'टीम छोड़ें', id: 'Keluar dari tim', ms: 'Tinggalkan pasukan', sw: 'Ondoka timu');
  String get teamMembers        => _t(ar: 'الأعضاء', en: 'Members', fr: 'Membres', es: 'Miembros', tr: 'Üyeler', ur: 'اراکین', hi: 'सदस्य', id: 'Anggota', ms: 'Ahli', sw: 'Wanachama');
  String get teamCreated        => _t(ar: 'تم إنشاء الفريق', en: 'Team created', fr: 'Équipe créée', es: 'Equipo creado', tr: 'Takım oluşturuldu', ur: 'ٹیم بن گئی', hi: 'टीम बन गई', id: 'Tim dibuat', ms: 'Pasukan dicipta', sw: 'Timu imeundwa');
  String get joinedTeam         => _t(ar: 'انضممت إلى الفريق', en: 'Joined the team', fr: 'Équipe rejointe', es: 'Te uniste al equipo', tr: 'Takıma katıldın', ur: 'ٹیم میں شامل ہو گئے', hi: 'टीम में शामिल हुए', id: 'Bergabung dengan tim', ms: 'Menyertai pasukan', sw: 'Umejiunge na timu');
  String get teamNotFound       => _t(ar: 'لم يُعثر على فريق بهذا الرمز', en: 'No team found with this code', fr: 'Aucune équipe pour ce code', es: 'No hay equipo con ese código', tr: 'Bu kodla takım bulunamadı', ur: 'اس کوڈ سے کوئی ٹیم نہیں ملی', hi: 'इस कोड से कोई टीम नहीं मिली', id: 'Tim tidak ditemukan', ms: 'Tiada pasukan dengan kod ini', sw: 'Hakuna timu kwa msimbo huu');
  String get leftTeam           => _t(ar: 'غادرت الفريق', en: 'Left the team', fr: 'Équipe quittée', es: 'Saliste del equipo', tr: 'Takımdan ayrıldın', ur: 'ٹیم چھوڑ دی', hi: 'टीम छोड़ दी', id: 'Keluar dari tim', ms: 'Meninggalkan pasukan', sw: 'Umeondoka timu');
  String get teamNameRequired   => _t(ar: 'أدخل اسم الفريق', en: 'Enter a team name', fr: 'Saisissez un nom d\'équipe', es: 'Ingresa un nombre de equipo', tr: 'Bir takım adı girin', ur: 'ٹیم کا نام درج کریں', hi: 'टीम का नाम दर्ज करें', id: 'Masukkan nama tim', ms: 'Masukkan nama pasukan', sw: 'Weka jina la timu');
  String get teamSignInHint     => _t(ar: 'سجّل الدخول عبر Google لاستخدام الفرق', en: 'Sign in with Google to use teams', fr: 'Connectez-vous avec Google pour les équipes', es: 'Inicia sesión con Google para usar equipos', tr: 'Takımlar için Google ile giriş yap', ur: 'ٹیمز کے لیے Google سے سائن ان کریں', hi: 'टीम के लिए Google से साइन इन करें', id: 'Masuk dengan Google untuk tim', ms: 'Log masuk dengan Google untuk pasukan', sw: 'Ingia na Google kutumia timu');
